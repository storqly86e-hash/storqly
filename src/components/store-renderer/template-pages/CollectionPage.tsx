            ...
            return (
              ...
              >
                ...
                <div className="p-3 sm:p-4" style={{ color: theme.colors.text }}>
                  ...
                  {product.inStock && (
                    <button
                      className="mt-3 w-full rounded-md py-2 text-xs font-semibold transition-all duration-200 cursor-pointer opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0"
                      style={{
                        backgroundColor: theme.colors.primary,
                        color: contrastTextColor(theme.colors.primary),
                      }}
